...
module.exports = {
  ...
  COMMENT_GISCUS_CATEGORY:
    process.env.NEXT_PUBLIC_COMMENT_GISCUS_CATEGORY || 'giscus', // 你的Github Discussions 內的 Category 名称 e.g 'General' ( 設定完 giscus 即可看到 )
  COMMENT_GISCUS_CATEGORY_ID:
    process.env.NEXT_PUBLIC_COMMENT_GISCUS_CATEGORY_ID || 'DIC_kwDOIjHvBs4CS5T5', // 你的Github Discussions 內的 Category ID ( 設定完 giscus 即可看到 )
  ...
  COMMENT_WALINE_SERVER_URL: process.env.NEXT_PUBLIC_WALINE_SERVER_URL || 'https://w.iorimaboroshi.asia/', // 请配置完整的Waline评论地址 例如 hhttps://preview-waline.tangly1024.com @see https://waline.js.org/guide/get-started.html
