...
const BLOG = {
  ...
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '萌ICP备20224002', // 备案号 闽ICP备XXXXXXX
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || '话痨小幻', // 站点标题 ，被notion中的页面标题覆盖
  DESCRIPTION:
    process.env.NEXT_PUBLIC_DESCRIPTION || '幻幻的日常', // 站点描述，被notion中的页面描述覆盖
