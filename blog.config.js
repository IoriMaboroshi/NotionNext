...
const BLOG = {
  ...
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '萌ICP备20224002号', // 备案号 闽ICP备XXXXXXX
  ...
  COMMENT_GISCUS_REPO: process.env.NEXT_PUBLIC_COMMENT_GISCUS_REPO || 'IoriMaboroshi/NotionNext', // 你的Github仓库名 e.g 'tangly1024/NotionNext'
  COMMENT_GISCUS_REPO_ID: process.env.NEXT_PUBLIC_COMMENT_GISCUS_REPO_ID || 'R_kgDOIjHvBg', // 你的Github Repo ID e.g ( 設定完 giscus 即可看到 )
  COMMENT_GISCUS_CATEGORY_ID: process.env.NEXT_PUBLIC_COMMENT_GISCUS_CATEGORY_ID || 'DIC_kwDOIjHvBs4CS5T5', // 你的Github Discussions 內的 Category ID ( 設定完 giscus 即可看到 )
  ...
  // 作废配置
  AVATAR: 'https://b.chwin.asia/wp-content/uploads/2022/11/cropped-lab.magiconch.com90s-time-machine-1667800846069.jpg', // 作者头像，被notion中的ICON覆盖。若无ICON则取public目录下的avatar.png
  TITLE: '话痨小幻', // 站点标题 ，被notion中的页面标题覆盖
  HOME_BANNER_IMAGE: './bg_image.jpg', // 首页背景大图, 会被notion中的封面图覆盖，若无封面图则会使用代码中的 /public/bg_image.jpg 文件
  DESCRIPTION: '幻幻的日常', // 站点描述，被notion中的页面描述覆盖
